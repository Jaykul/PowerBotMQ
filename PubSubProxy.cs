...
namespace PoshCode
{
	...
	public class PubSubProxy : Job
	{
		...
		public PubSubProxy(string publisherAddress, string subscriberAddress, int heartbeat = 0, NetMQSocket control = null)
		{
			...
			PSJobTypeName = typeof (PubSubProxy).FullName;
		...
		{
			return JobStateInfo.State + " PubSubProxy from (Sub): " + _subscriberAddress + " to (Pub): " + _publisherAddress;
		}
		...
		{
			get { return "Pub: " + _publisherAddress + " Sub: " + _subscriberAddress; }
		}
